...
public class iMacsPageGridView_Action extends LoadableComponent<iMacsPageGridView_Action> {
	PublicFunctions pf = new PublicFunctions();
	iMacsPage imp = new iMacsPage();
	public WebDriver driver;
	
	public iMacsPageGridView_Action() {
	...
	protected void load() {
		...
		driver.navigate().to(_Constants.URLiMacsPageGrid);
	...
	public void assertPageText() {
		...
		pf.captureScreenShot(driver, "TC005_TS1_iMacsPageGridView");
	}
